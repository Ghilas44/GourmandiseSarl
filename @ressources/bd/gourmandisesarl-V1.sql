...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 04 Avril 2018 à 18:20
...
(54, 'DURDUX Monique', '15 allÃ©e des Béarnais', '51150', 'VITRY LE FRANCOIS', '03.26.42.42.33'),
...
CREATE TABLE IF NOT EXISTS `commande` (
  `numero` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Num?ro de la commande',
  ...
  PRIMARY KEY (`numero`),
  KEY `clientcommande` (`codec`),
  KEY `vendeurcommande` (`codev`)
...
INSERT INTO `vendeur` (`codev`, `nom`, `adresse`, `cp`, `ville`, `telephone`) VALUES
