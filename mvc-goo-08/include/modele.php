...
abstract class Modele {
	...
	private function getBD() {
		...
		if ($this->cnx == NULL) {
			...
			$this->cnx = new PDO('mysql:host=localhost; dbname=gourmandisesarl', 'root', '', array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8", PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
